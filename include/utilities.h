...
#include "LaseCamCalCeres.h" // yanhao
...
//yanhao
void getPointsIntensity(const sensor_msgs::LaserScan& scan_in,std::vector<float>& Intensity_oneScan); // get intensity of one scan
float getAngleIncrement(const sensor_msgs::LaserScan& scan_in); // get angle increment
